// Definisi item, senjata per class, dan drop table musuh.
...
export const ITEMS = {
  ...
  forge_stone:  { name: 'Batu Tempa' },

  // konsumabel
  tonic: { name: 'Health Tonic', consumable: true, heal: 40 },

  // ---- SENJATA ----
  // sword (Ksatria): melee arc lebar
  ...
  // staff (Penyihir): bolt sihir meledak kecil
  ...
  // dagger (Pembunuh): 2 tusukan cepat per serangan

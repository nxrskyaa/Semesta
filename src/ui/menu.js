...
export function showOpening(saved) {
  return new Promise(async (resolve) => {
    ...
    about.innerHTML = `
      <div class="card">
        <img class="mascot" src="${logo}" alt="Semesta">
        <h4>◆ ABOUT SEMESTA ◆</h4>
        ...
        <div class="crew">
          ...
          <div class="member">
            <div class="who"><b>Nxrskyaa</b><small>CREATOR</small></div>
            <a class="xmini" href="https://x.com/nxrskyaa" target="_blank" rel="noopener">𝕏 FOLLOW</a>
          </div>
          <div class="member">
            <div class="who"><b>Dikzzy</b><small>MECHANICS GAME BUILDER</small></div>
            <a class="xmini" href="https://x.com/diikzzyy__" target="_blank" rel="noopener">𝕏 FOLLOW</a>
          </div>
          <div class="member">
            <div class="who"><b>Baster</b><small>GAME ENGINE DEVELOPER</small></div>
            <a class="xmini" href="https://x.com/Bas_Basterx" target="_blank" rel="noopener">𝕏 FOLLOW</a>
          </div>
        </div>
